			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						...
						<!-- ALTERADO, OLHAR DEPOIS QUAL É A CORRETA -->
						<li><a href="<c:url value="/shopping/itens"/>" rel="nofollow">Seu carrinho (${shoppingCart.quantity}) </a></li>
		...
		<header id="product-highlight" class="clearfix">
			<div id="product-overview" class="container">
				...
				<p itemprop="description" class="book-description">
					${product.description} Veja o <a href="<c:url value='/${product.summaryPath}'/>" target="_blank">sum&#225;rio</a> completo do livro!
				</p>
			</div>
		</header>
